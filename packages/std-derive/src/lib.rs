...
pub fn derive_cosmwasm_ext(input: TokenStream) -> TokenStream {
        ...
        .is_some()
    {
        ...
        let cosmwasm_query = quote! {
            ...
            pub fn mock_response<T: desmos_mock::MockableQuerier>(querier: &mut T, response: #res) {
            ...
            pub fn mock_failed_response<T: desmos_mock::MockableQuerier>(querier: &mut T, error: String) {
                querier.register_custom_query(#path.to_string(), Box::new(move |data| {
